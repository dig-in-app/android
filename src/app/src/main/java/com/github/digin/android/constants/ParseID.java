...
public class ParseID {
    ...
    public static final String F_BREW_CITY = "city";
    public static final String F_BREW_THUMB = "thumbnail";
    public static final String F_BREW_WEB = "website";
    ...
    public static final String F_CHEF_THUMB = "thumbnail";
    public static final String F_CHEF_WEB = "website";
    public static final String F_CHEF_YELP = "yelpURL";
    public static final String F_CHEF_CITY = "city";
    public static final String F_CHEF_DISH = "dishTitle";
    public static final String F_CHEF_CHEFNAME = "chefName";
    ...
    public static final String F_DEMO_PRES = "presenter";
    public static final String F_DEMO_DESC = "description";
    ...
    public static final String F_WINE_CITY = "city";
    public static final String F_WINE_THUMB = "thumbnail";
    public static final String F_WINE_WEB = "website";
    public static final String F_WINE_YELP = "yelpURL";
    public static final String F_WINE_TENT = "tent";
